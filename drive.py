    ...
    try:
        with open(image_path, "rb") as image_file:
            ...
            try:
                file = (
                    service.files()
                    .create(body=file_metadata, media_body=media, fields="id,webViewLink,permissions")
                    .execute()
                )
                ...
                permissions = service.permissions().create(fileId=file.get('id'), body=permission_body).execute()
